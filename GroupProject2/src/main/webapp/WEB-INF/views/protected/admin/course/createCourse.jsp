...
<form class="form-horizontal" action="createCourseWithoutReq" method="post">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="courseName" type="text" placeholder="Enter course name" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="startDate" type="date" placeholder="Enter start date" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="endDate" type="date" placeholder="Enter end date" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="price" type="number" placeholder="Enter price" class="form-control input-md" required="">
