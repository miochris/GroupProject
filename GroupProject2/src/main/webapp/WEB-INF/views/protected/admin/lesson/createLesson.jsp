	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
          ...
          <li><a href="adminViewRequest?type=${'L' }">Lesson Requests(${fn:length(lessonRequest)})</a></li> 
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">BEAN Fam <span class="caret"></span></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">Academia <span class="caret"></span></a>
					<ul class="dropdown-menu">
...
<!-- 		<tr> -->
<!-- 			<td> -->
<!-- 				<form action="listTutors" method="post"> -->
<!-- 					<select name="courseName" onchange="this.form.submit()"> -->
<%-- 						<c:choose> --%>
<%-- 							<c:when test="${empty courseName }"> --%>
...
<%-- 								value="${Course.courseName }">${Course.courseName }</option> --%>
<%-- 						</c:forEach> --%>
<!-- 					</select> -->
<!-- 				</form> -->
<!-- 			</td> -->
<%-- 			<sf:form action="createLessonWithoutReq" method="post" --%>
<%-- 				modelAttribute="lesson"> --%>
<!-- 				<td><select name="tutorUsername"> -->
<!-- 						<option value="NONE" label="--- Select ---" /> -->
...
<!-- 	</table> -->
		...
		<fieldset>
	<form class="form-horizontal" action="listTutors" method="post">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<select name="courseName" onchange="this.form.submit()" class="form-control">
						<c:choose>
							<c:when test="${empty courseName }">
								<option value="NONE" label="--- Select ---" />
							</c:when>
	...
	<sf:form class="form-horizontal" action="createLessonWithoutReq" method="post" modelAttribute="lesson">
			
			<!-- Select Basic -->
			<div class="form-group">
				<label class="col-md-4 control-label" for="selectbasic">Select Tutor</label>
				<div class="col-md-4">
					<select name="tutorUsername" class="form-control">
						<option value="NONE" label="--- Select ---" />
						<c:forEach var="Tutor" items="${tutorsList }">
							<option value="${Tutor.username }">${Tutor.username }</option>
						</c:forEach>
			...
			<!-- Text input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="textinput">Lesson Name</label>
				<div class="col-md-4">
					<sf:input id="textinput" path="name" type="text"
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<button id="singlebutton" type="submit" name="submit"
