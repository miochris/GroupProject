...
<html lang="en">
<head>
<title>Course Request Sent</title>
<meta charset="utf-8">
...
<h2>Thank you: ${user.firstname} ${user.lastname} Your request to add <c:out value="${courseAddRequest.courseName}"/> has been submitted.</h2>
<div class="col-sm-1"></div>
</div>
</div>
